...
import { aB as TxBuilder, at as AddInstructionParam, ac as BigNumberish, bo as CreateFarm, aA as MakeTxData, bp as CreateFarmExtInfo, bq as UpdateFarmReward, br as UpdateFarmRewards, bs as FarmDWParam, Y as FormatFarmInfoOut, bM as ComputeBudgetConfig, az as MakeMultiTxData, p as ApiV3PoolInfoStandardItem, c9 as Percent, c5 as TokenAmount, w as AmmV4Keys, x as AmmV5Keys, o as ApiV3PoolInfoConcentratedItem, X as FormatFarmInfoOutV6, z as ClmmKeys, bI as MakeTransaction, bR as ReturnTypeFetchMultipleMintInfos, C as CpmmKeys, q as ApiV3PoolInfoStandardItemCpmm, bP as GetTransferAmountFee, B as PoolKeys, i as ApiV3Token, $ as OwnerIdoInfo, a0 as IdoKeysData, bN as LoadParams, J as JupTokenType, bD as TokenInfo, bH as SignAllTransactions, a as Api, Z as AvailabilityCheckAPI3, j as ApiV3TokenRes } from './api-00e732a2.js';
...
import { n as CreateConcentratedPool, O as OpenPositionFromBase, q as OpenPositionFromBaseExtInfo, r as OpenPositionFromLiquidity, s as OpenPositionFromLiquidityExtInfo, I as IncreasePositionFromLiquidity, M as ManipulateLiquidityExtInfo, o as IncreasePositionFromBase, D as DecreaseLiquidity, E as ClosePositionExtInfo, L as LockPosition, H as HarvestLockPosition, t as InitRewardParams, F as InitRewardExtInfo, u as InitRewardsParams, v as SetRewardParams, w as SetRewardsParams, x as CollectRewardParams, y as CollectRewardsParams, z as HarvestAllRewardsParams, J as ClmmRpcData, d as ComputeClmmPoolInfo, m as ReturnTypeFetchMultiplePoolTickArrays } from './type-478224ed.js';
...
declare class Clmm extends ModuleBase {
    ...
    lockPosition<T extends TxVersion>(props: LockPosition<T>): Promise<MakeTxData<T>>;
